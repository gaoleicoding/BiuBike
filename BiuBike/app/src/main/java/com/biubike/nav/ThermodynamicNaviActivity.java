...
// */
//public class ThermodynamicNaviActivity extends NewBaseActivity implements View.OnClickListener {
...
//  public static final String EXTRA_ORDER = "entry";
//  /**
//   * 更新 聊天界面 布局红点
//   */
...
//  private ThermodynamicEntry entry;
...
//    entry = (ThermodynamicEntry) getIntent().getSerializableExtra(EXTRA_ORDER);
...
//
//    //if (tvAddress!=null){
//    //  tvAddress.setText(StringUtil.subString(entry.getPosition_end()));
//    //}
//
//  }
//  @Override
...
//    //
//    //  String passenger_name = entry.getPassenger_name();
//    //  tvPassengerName.setText(!TextUtils.isEmpty(passenger_name)?passenger_name : "null");
//    //  tvStartAddress.setText(StringUtil.subString(entry.getPosition_start()));
...
//        items = new ArrayList<BNRouteGuideManager.CustomizedLayerItem>();
...
//
//      case R.id.call:
//        //Intent intentCall = new Intent(Intent.ACTION_DIAL, Uri.parse("tel:" + entry.getPassenger_contact()));
...
//        //    entry.setPosition_end_lat(address.getLatitude());
//        //    entry.setPosition_end_lng(address.getLongitude());
//        //    entry.setPosition_end(address.getName());
//        //    //TODO 待处理
//        //    YongcheProgress.showProgress(ThernodymicNaviActivity.this,"正在重新规划路线");
//        //    NavUtil.launchInnerNavis(ThernodymicNaviActivity.this,navimode, entry);
//        //  }
//        //});
...
//    //  if (entry != null && TextUtils.isEmpty(entry.getChat_id_passengers())) {
//    //    YongcheProgress.showProgress(this, "正在为您连接乘客...");
//    //    getChatId(0, entry.getId());
//    //    return;
//    //  }
//    //}
//    //initChatActivity(0);
...
//    //        YongcheProviderData.getInStance(ThernodymicNaviActivity.this).upDateOrderEntryForChat(
//    //            OrderColumn.CHAT_ID_PASSENGERS, chatID_person, order_id);
//    //        entry.setChat_id_passengers(chatID_person);
